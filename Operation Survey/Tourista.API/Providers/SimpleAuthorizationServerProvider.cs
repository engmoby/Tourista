...
namespace Tourista.API.Providers
{
    public class SimpleAuthorizationServerProvider : OAuthAuthorizationServerProvider
    {
        ...
        private AuthenticationTicket GetAuthenticationTicket(UserDto user)
        {
            ...
            identity.AddClaim(new Claim(Strings.userName, user.FullName));
          ...
          //identity.AddClaim(new Claim(Strings.PermissionId, string.Join(";", user.PermissionId)));
            // identity.AddClaim(new Claim(ClaimTypes.Country, user.Country.ToString()));
