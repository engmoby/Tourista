...
using Exceptions = Tourista.Common.CustomException;

namespace Tourista.API.Infrastructure.Filters
{
    public class CustomExceptionFilter : ExceptionFilterAttribute
    {
        ...
        protected string GetResourceMessage(string key)
        {
            ...
            {
                _resourceManager = new ResourceManager("Tourista.Resources.Resource", typeof(Tourista.Resources.Resource).Assembly);
            }
