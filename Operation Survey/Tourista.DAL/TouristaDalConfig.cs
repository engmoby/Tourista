        ...
        public static void RegisterTypes(IUnityContainer container)
        {
            container
                ...
                .RegisterType<IRepositoryAsync<CountryTranslation>, Repository<CountryTranslation>>(new PerResolveLifetimeManager())
                 .RegisterType<IRepositoryAsync<Type>, Repository<Type>>(new PerResolveLifetimeManager())
                .RegisterType<IRepositoryAsync<TypeTranslation>, Repository<TypeTranslation>>(new PerResolveLifetimeManager())
