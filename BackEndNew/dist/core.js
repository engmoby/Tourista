  ...
  angular
    .module('core').config(["$translateProvider", "appCONSTANTS", function ($translateProvider, appCONSTANTS) {
      ...
      var en_translations = {
        ...
        "PackageAddSuccess": "Package Add Success",
        "PackageEditSuccess": "Package Edit Success",
      ...
      var ar_translations = {
        ...
        "PackageAddSuccess": "تم اضافه الباقه بنجاح   ",
        "PackageEditSuccess": "تم تعديل الباقه بنجاح   ",
        ...
        "NoPackageAvailable": "لا يوجد باقاات",
        "View": "عرض",
        "AddNew": "إضافه",
        "Answers": "الأجوبة",
        "filterBtn": "تصفيه",
